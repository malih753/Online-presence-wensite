...
function Section1() {
  return (
    <div className="w-full  flex items-center flex-col lg:flex-row px-4 md:px-[104px]">
      ...
      <div className="w-full lg:w-[50%] mt-[-85px] max-md:mt-[15px] max-lg:mt-[20px] 2xl:mt-0 " id="formData">
        <div className="w-full md:pl-[37px] md:mt-[108px]">
          ...
          <div className="bg-white p-8 rounded-[20px] shadow-custom relative z-10 w-full">
            <h2 className="text-xl font-bold text-orange-500 mb-4">
              Kickstart your business!!
            </h2>
            <p className="mb-4 text-gray-700">
              Fill in the details below and our team will get back to you in no time
            </p>
            <form>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <select className="w-full p-2 border border-gray-300 rounded mt-1 bg-white ">
                    <option >
              ...
              <button
                type="submit"
                className="bg-orange-500 text-white py-2 px-4 rounded w-[170px] mt-4"
              >
                Get a Quote
              </button>
            </form>
